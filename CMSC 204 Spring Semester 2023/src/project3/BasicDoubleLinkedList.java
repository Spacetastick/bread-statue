...
//			
//			size--; //decrementing for removing
//			if (comparator.compare(targetData, data) == 0) {
//				//CAUSING ISSUES WITH LAST ELEMENT
//				iterator.previous();
//				
//				Node<T> temp = iterator.cursor;
//				
//				//might be wrong because temp is actually pointing to the node after and not the current/first node
...
//		BasicDoubleLinkedList<String> bruh = new BasicDoubleLinkedList<>();
//		
//		bruh.addToFront("1");
//		bruh.addToFront("2");
//		bruh.addToEnd("3");
...
//		bruh.addToEnd("5");
//		
//		String[] array = {"5", "3", "1", "2", "4"};
//		StringComparator comparator = new StringComparator();
//		
//		for (int i = bruh.size; i > 0; i--) {
//			System.out.print(bruh.getFirst() + ", ");
//			System.out.println(array[i-1] + " is i-1");
//			System.out.println("size of list is " + bruh.size);
//			System.out.println(bruh.remove(array[i-1], comparator).data + " removed");
//		}
//		
//		//doesn't work
////		System.out.println(bruh.toArrayList().toString());
//	}
//	
//	
//	
